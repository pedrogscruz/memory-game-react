...
export function saveMatch(match, callback) {
	return async dispatch => {
		try {
			const res = await axios.post('http://5b55d99f503d920014688807.mockapi.io/send4/memoryGame/savedMatches', match);
...
export function finishedMatch(match, callback) {
	return async dispatch => {
		try {
			const res = await axios.post('http://5b55d99f503d920014688807.mockapi.io/send4/memoryGame/matches', {...match, createdAt: new Date()});
